...
const UUID = process.env.UUID || 'f816722e-bfaa-4d4f-b018-bfc975c2a3ba'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'ahtvxvzxunopnygt.slack.priv.at';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjViYWMyNDJjMWZkMmUyYjFmMDQ0ZTMwNDA2Yjk4YmYiLCJ0IjoiZjRiYjAyMDQtZTNjZi00ODFiLTkxZmMtZGU2ZTM4ZjZkYTAxIiwicyI6Ik5HVm1ZMlpqWkRjdE4yUmxOaTAwTm1VeUxUazJZbUl0TUdNd01tTXlOV1F3WWpFMSJ9';
const CFIP = process.env.CFIP || 'digitalocean.com';
